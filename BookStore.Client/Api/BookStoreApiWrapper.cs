...
public class BookStoreApiWrapper(IConfiguration configuration) : IBookStoreApiWrapper
{
    ...
    public async Task<IList<StringInt32Tuple>> GetTop5Authors() => [..await _client.Top5AuthorsAsync()];
    public async Task<IList<StringInt32Tuple>> GetLast5Books(int id) => [.. await _client.Last5BooksAsync(id)];
}